...
import { GROUPID, USER_LOGIN } from "../../util/apiSetting";
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object().shape({
      taiKhoan: Yup.string()
        ...
        .min(6, "Tài khoản có ít nhất 6 kí tự"),
      matKhau: Yup.string()
        .trim()
    ...
    onSubmit: (values) => {
      console.log(values);
      dispatch(postValueRegister(values));
      // switch (message) {
              ...
              <form onSubmit={formik.handleSubmit}>
                ...
                <div className="flex items-center justify-center mt-3">
                  <div className="text-sm">
                    <NavLink
                      to="/login"
                      className="font-medium text-red-600 hover:text-gray-900 "
                    >
                ...
                <div>
                  <button
                    ...
                    className={`relative w-full flex justify-center py-2 px-4 border border-transparent text-xl font-medium rounded-md text-white  hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-600 mt-3 cursor-pointer ${
                      formik.isValid ? `bg-red-600` : `bg-red-700`
                    }`}
                  >
