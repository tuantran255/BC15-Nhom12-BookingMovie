...
import { postValueRegisterOfAdmin } from "../../../../redux/slices/registerSlice";
...
export default function AddUser() {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      dispatch(postValueRegisterOfAdmin(thongTinDangKy));
    },
  });
  ...
  return (
    <div>
      <h1 className="text-center font-black text-red-600 text-3xl mb-10">
        Thêm người dùng
      </h1>
